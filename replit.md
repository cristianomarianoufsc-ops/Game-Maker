...
- Fase: aplicada chave do editor adicionando um objeto `sprite` em x:16528 yOffset:-284 com tamanho 474x474 e rotação 1°; a vinculação incorreta ao print anexado foi removida.
