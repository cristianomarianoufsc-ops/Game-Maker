...
- Ajuste visual/físico: pneus rolantes gerados por `tireHideout` ao serem atingidos pelo drone ficaram um pouco maiores (raio baseado em 40% da largura da pilha, limitado a 38px).
