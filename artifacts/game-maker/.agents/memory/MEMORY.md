...
- [Configurações de áudio entre clones](audio-settings-clones.md) — valores que precisam viajar no Git devem ser confirmados no JSON versionado, não apenas no localStorage do navegador.
