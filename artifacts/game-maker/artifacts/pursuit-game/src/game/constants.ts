...
// Energia de mergulho — gasta ~1/3 por mergulho (permite 3 seguidos), recarrega com o tempo
export const DIVE_ENERGY_MAX = 100;
export const DIVE_ENERGY_COST = 100 / 3; // ~33.33% por mergulho
export const DIVE_ENERGY_REGEN_PER_MS = 100 / 32000; // recarga total em ~32s parado sem mergulhar
